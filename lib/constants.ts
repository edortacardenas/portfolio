...
export const experiences = [
  ...
  },
  {
    ...
    imagePlaceholder: "/Clerk.webp", // Replace with your actual screenshot
    liveLink: "https://authclerk-pi.vercel.app/", // Replace with your actual live link
  },
  {
    role: "INDEPENDENT PROGRAMMER",
    period: "2022-2023",
    description: "I developed 'Hoteles.sa', a modern web application built on Next.js to ensure optimal performance. Its user interface was crafted with Shadcn/ui for high-quality, accessible components and styled with TailwindCSS. The platform integrates Stripe for secure payment processing.",
